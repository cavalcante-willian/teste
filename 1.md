...
Exemplos:
- backup-pool/fileserver@snapshot-2026-01-15-09:00
- backup-pool/fileserver@snapshot-2026-01-15-17:00
- backup-pool/email@snapshot-2026-01-15-09:00
```
...
1. Identificar snapshot mais próximo ANTES do problema
   - Lista:  backup-pool/fileserver@snapshot-2026-01-15-09:00 (mais recente)
2. Navegar no snapshot (montagem read-only automática ZFS)
   - Caminho: /backup-pool/fileserver/. zfs/snapshot/snapshot-2026-01-15-09:00/
...
5. Sistema: 
   ...
   - Blacklist ble_uuid
   - Log auditoria:  "Acesso João Silva revogado por Admin em 2026-01-15 15:30"
...
**Log Auditoria:**
- "Novo usuário Maria Santos adicionado VPN por Admin em 2026-01-15"
...
4. **Navegar Snapshot ZFS**
   - cd /backup-pool/fileserver/.  zfs/snapshot/snapshot-2026-01-15-09: 00/
...
3. **Snapshot Emergencial (Mesmo Se Comprometido)**
   ...
   - Snapshot criado: backup-pool/fileserver@emergency-2026-01-15-16:45
...
9. **Restore (Se Necessário)**
   ...
   - Ex: backup-pool/fileserver@snapshot-2026-01-15-09:00
   - Validar integridade
...
| ------ | ---------- | --------- | ----------------------- |
| 1.0    | 2026-01-15 | Equipe TI | Versão inicial aprovada |
