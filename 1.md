...
stateDiagram-v2
    ...
    state Normal {
        [*] --> Fibra1_Primary
        Fibra1_Primary: OK - Fibra 1 Ativa (BGP Established)
        Fibra1_Primary: IPv6 - 2801:1234:5678::/48
        Fibra1_Primary: Trafego - 100% via Fibra 1
        Fibra1_Primary: Local Pref - 200
        Fibra1_Primary: NAT - Desabilitado
        Fibra1_Primary: Latencia - 15-30ms
    }

    state Failover1 {
        [*] --> Fibra2_Active
        Fibra2_Active: ATENCAO - Fibra 1 DOWN, Fibra 2 Ativa
        Fibra2_Active: BGP Converge (~30-90s)
        Fibra2_Active: Trafego - 100% via Fibra 2
    ...
    state Disaster {
        [*] --> Starlink_Only
        Starlink_Only: CRITICO - Ambas Fibras DOWN
        Starlink_Only: BGP Global - Rotas removidas
        Starlink_Only: Palo Alto - Source NAT ativo
        Starlink_Only: IPv6 Direto - Inacessivel
        Starlink_Only: Cloudflare Tunnel - OK Assume
        Starlink_Only: Sites HTTP/HTTPS - OK Funcionam
        Starlink_Only: Latencia - 40-80ms
    }

    Normal --> Failover1: Fibra 1 Falha (BGP Hold Timer)
    Failover1 --> Normal: Fibra 1 Restaurada (BGP Re-established)
    Failover1 --> Disaster: Fibra 2 Falha (Ambas Down)
    Normal --> Disaster: Ambas Fibras Falham (Raro)
